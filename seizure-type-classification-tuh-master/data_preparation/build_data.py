...
# python data_preparation/build_data.py --base_dir ../data --save_data_dir ../data --tuh_eeg_szr_ver v1.5.2
...
def main():
    ...
    parser.add_argument('--base_dir', default='../data', help='path to raw seizure dataset')
    parser.add_argument('--save_data_dir', default='../data', help='path to save processed data')
