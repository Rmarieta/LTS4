...
if __name__ == "__main__":
    ...
    build_dir(input_dir, ['dev'], seizure_types, graph_dir)
    
    # Same for the train dataset
    Laplacian_train_dict = compute_Laplacian(input_dir, 'dev', seizure_types, restrict_size, ignore_L) 
    print('\n\nSaving the graphs as .npy files...\n')
    save_graphs(Laplacian_train_dict, graph_dir, 'dev')
    print('\n...Saving done\n\n')
