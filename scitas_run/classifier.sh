...
#SBATCH --output ./cluster_output/1s_CNN.out
...
# To run the FC_NN :
#python -u classifier/FC_NN.py --input_dir './data/v1.5.2/graph_lapl_nolow_a1_b1' --nb_epochs 200 --save_model 'True' --batch_size 30

# To run the CNN :
python -u classifier/CNN.py --input_dir './data/v1.5.2/graph_lapl_nolow_1s' --nb_epochs 115 --save_model 'True' --batch_size 30 --upper 'True' --is_cov 'False'
