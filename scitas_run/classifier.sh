...
#python -u classifier/graph_classifier.py --graph_dir './data/v1.5.2/graph_lapl_low_100' --algo 'logit' --seizure_types 'FNSZ' 'GNSZ' --cross_val 'False' --is_cov 'False' --over_conn 'True'

# To train the FC_NN :
#python -u classifier/FC_NN.py --input_dir './data/v1.5.2/graph_lapl_low_100' --nb_epochs 50 --save_model 'False' --batch_size 30 --over_conn 'True' --save_model 'False'

# To train the CNN :
#python -u classifier/CNN.py --input_dir './data/v1.5.2/graph_lapl_low_100' --nb_epochs 50 --save_model 'False' --batch_size 30 --upper 'True' --is_cov 'False' --revert 'False' --over_conn 'True'
