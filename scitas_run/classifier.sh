...
#SBATCH --output ./cluster_output/cov_FNN.out
...
# To train the FC_NN :
#python -u classifier/FC_NN.py --input_dir './data/v1.5.2/graph_lapl_low_50' --nb_epochs 40 --save_model 'False' --batch_size 30 --over_conn 'True' --save_model 'False' --is_cov 'False'

# To train the CNN :
#python -u classifier/CNN.py --input_dir './data/v1.5.2/graph_lapl_nolow' --nb_epochs 50 --save_model 'False' --batch_size 30 --upper 'True' --is_cov 'False' --revert 'False' --over_conn 'True'
